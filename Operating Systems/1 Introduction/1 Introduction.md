...
1. [What is an Operating System](#what-is-an-operating-system)
	1. [OS goals](#os-goals)
2. [Computer System Structure](#computer-system-structure)
	1. [Components](#components)
3. [Abstract View of Components of Computer](#abstract-view-of-components-of-computer)
4. [What Operating Systems Do](#what-operating-systems-do)
5. [Defining Operating Systems](#defining-operating-systems)
6. [Operating System Definition](#operating-system-definition)
7. [Computer System Organization](#computer-system-organization)
8. [Computer System Operation](#computer-system-operation)
9. [Interrupt](#interrupt)
	1. [Common Functions of Interrupts](#common-functions-of-interrupts)
	2. [Interrupt vector](#interrupt-vector)
	3. [Interrupt Service Routine](#interrupt-service-routine)
	4. [Examples (from ChatGPT)](#examples-from-chatgpt)
	5. [Interrupt Timeline](#interrupt-timeline)
	6. [Interrupt types](#interrupt-types)
	7. [Interrupt-drive I/O Cycle](#interrupt-drive-io-cycle)
10. [I/O Structure](#io-structure)
	1. [Two methods for handling I/O](#two-methods-for-handling-io)
11. [Storage Structure](#storage-structure)
	1. [Main memory](#main-memory)
	2. [Secondary Storage](#secondary-storage)
	3. [Definitions and Notation](#definitions-and-notation)
12. [Storage Device Hierarchy](#storage-device-hierarchy)
13. [Direct Memory Access Structure](#direct-memory-access-structure)
	1. [DMA Example](#dma-example)
14. [Operating System Operations](#operating-system-operations)
15. [System Call](#system-call)
	1. [Examples](#examples)
16. [Multiprogramming & Multitasking](#multiprogramming--multitasking)
	1. [Multi programming](#multi-programming)
	2. [Multi-tasking](#multi-tasking)
		1. [Keywords](#keywords)
17. [Dual mode operation](#dual-mode-operation)
18. [Timer](#timer)
19. [Resource Management](#resource-management)
	1. [Process Management](#process-management)
		1. [Process Management Activities](#process-management-activities)
	2. [Memory Management](#memory-management)
		1. [Memory Management Activities](#memory-management-activities)
	3. [File-system Management](#file-system-management)
		1. [File-system Management Activities](#file-system-management-activities)
	4. [Mass-Storage Management](#mass-storage-management)
	5. [Caching](#caching)
	6. [Characteristics of Various Types of Storage](#characteristics-of-various-types-of-storage)
	7. [Migration of data "A" from Disk to Register](#migration-of-data-a-from-disk-to-register)
20. [I/O Subsystem](#io-subsystem)
	1. [I/O Subsystem components](#io-subsystem-components)
21. [Protection and Security](#protection-and-security)
	1. [Protection](#protection)
	2. [Security](#security)
22. [Virtualization](#virtualization)
23. [Distributed Systems](#distributed-systems)
	1. [Network Operating System](#network-operating-system)
24. [Computer System Architecture](#computer-system-architecture)
	1. [Single-Processor Systems](#single-processor-systems)
	2. [Multiprocessors Systems](#multiprocessors-systems)
		1. [Dual-Core](#dual-core)
	3. [Multiprocessors Keywords](#multiprocessors-keywords)
	4. [Clustered Systems](#clustered-systems)
25. [Computing Environments](#computing-environments)
	1. [Traditional Computing](#traditional-computing)
	2. [Mobile Computing](#mobile-computing)
	3. [Client-Server Computing](#client-server-computing)
	4. [Peer-to-Peer Computing](#peer-to-peer-computing)
	5. [Cloud Computing](#cloud-computing)
	6. [Real-Time Embedded Systems](#real-time-embedded-systems)
26. [Free and Open-Source Operating Systems](#free-and-open-source-operating-systems)
